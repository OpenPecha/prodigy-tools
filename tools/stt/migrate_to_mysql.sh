...
# stt_cs_gd
sudo -u prodigy PRODIGY_CONFIG="/usr/local/prodigy/prodigy-tools/configuration/stt_cs_gd.json" /usr/bin/python3.9 -m prodigy db-out stt_cs_gd > ./stt_cs_gd.jsonl
sudo -u prodigy PRODIGY_CONFIG="/usr/local/prodigy/prodigy-tools/configuration/stt_cs_gd_review.json" /usr/bin/python3.9 -m prodigy db-out stt_cs_gd_review > ./stt_cs_gd_review.jsonl

sudo -u prodigy PRODIGY_CONFIG="./config_mysql.json" /usr/bin/python3.9 -m prodigy db-in stt_cs_gd ./stt_cs_gd.jsonl
sudo -u prodigy PRODIGY_CONFIG="./config_mysql.json" /usr/bin/python3.9 -m prodigy db-in stt_cs_gd_review ./stt_cs_gd_review.jsonl

# stt_cs_ge
sudo -u prodigy PRODIGY_CONFIG="/usr/local/prodigy/prodigy-tools/configuration/stt_cs_ge.json" /usr/bin/python3.9 -m prodigy db-out stt_cs_ge > ./stt_cs_ge.jsonl
sudo -u prodigy PRODIGY_CONFIG="/usr/local/prodigy/prodigy-tools/configuration/stt_cs_ge_review.json" /usr/bin/python3.9 -m prodigy db-out stt_cs_ge_review > ./stt_cs_ge_review.jsonl
...
# stt_ab_gb
sudo -u prodigy PRODIGY_CONFIG="./stt_ab.json" /usr/bin/python3.9 -m prodigy db-out stt_ab_gb > ./stt_ab_gb.jsonl
sudo -u prodigy PRODIGY_CONFIG="./config_mysql.json" /usr/bin/python3.9 -m prodigy db-in stt_ab_gb ./stt_ab_gb.jsonl