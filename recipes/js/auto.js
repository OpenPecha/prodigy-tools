...
AutoSuggestControl.prototype.typeAhead = function (sSuggestion /*:String*/) {
  ...
  if (this.textbox.createTextRange || this.textbox.setSelectionRange) {
    ...
    var lastTbQuote = this.textbox.value.lastIndexOf("༔");
 ...
 */
wordSuggestions.prototype.requestSuggestions = function (
  oAutoSuggestControl /*:AutoSuggestControl*/
) {
  var aSuggestions = [];
  var sTextbox = oAutoSuggestControl.textbox.value;
  var sTextboxSplit = sTextbox.split(/[ ]+/);
...
function wordSuggestions() {
  this.words = ['hello','dawa'];
}

document.querySelector(".prodigy-sidebar-title").innerHTML =
    "<h1>Pecha Tools</h1>";
...
setTimeout(function () {
    ...
    if (AutoSuggestControl) new AutoSuggestControl("user_input");
