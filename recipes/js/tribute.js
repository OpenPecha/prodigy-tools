  ...
  if (
    (Array.prototype.find ||
      (Array.prototype.find = function (e) {
        ...
        for (
          var t, n = Object(this), i = n.length >>> 0, r = arguments[1], o = 0;
          o < i;
          o++
        )
    ...
    void 0 !== window.Event && (r.prototype = window.Event.prototype),
          ...
          [
              ...
              value: function (e, n) {
                ...
                (e.commandEvent = !1),
                  t.keys().forEach(function (t) {
                    t.key === n.keyCode &&
                      ((e.commandEvent = !0),
                      e.callbacks()[t.value.toLowerCase()](n, i));
                  });
              },
            },
            {
              ...
              value: function (e, t) {
                ...
                if (n.menu && n.menu.contains(t.target)) {
                  ...
                  for (
                    ...
                    if (!(i = i.parentNode) || i === n.menu)
                      throw new Error(
                        "cannot find the <li> container for the click"
                      );
                  n.selectItemAtIndex(i.getAttribute("data-index"), t),
                    n.hideMenu();
                } else
                  n.current.element &&
                    !n.current.externalTrigger &&
                    ((n.current.externalTrigger = !1),
                    setTimeout(function () {
                      return n.hideMenu();
                    }));
              },
              ...
              value: function (e, t) {
                if (
                  ...
                  e.tribute.current.mentionText.length <
                    ...
                    ((((e.tribute.current.trigger ||
                      e.tribute.autocompleteMode) &&
                      !1 === e.commandEvent) ||
                      (e.tribute.isActive && 8 === t.keyCode)) &&
            ...
            },
            {
              ...
              value: function (e) {
                ...
                var t = this.tribute.range.getTriggerInfo(
                  !1,
              ...
              value: function () {
                ...
                return {
                  triggerChar: function (t, n, i) {
                    ...
                    (r.current.collection = o),
                      r.current.mentionText.length >=
                        r.current.collection.menuShowMinLength &&
                        r.inputEvent &&
                        r.showMenuFor(n, !0);
                  },
                  enter: function (t, n) {
                    e.tribute.isActive &&
                      e.tribute.current.filteredItems &&
                      (t.preventDefault(),
                      t.stopPropagation(),
                      setTimeout(function () {
                        e.tribute.selectItemAtIndex(e.tribute.menuSelected, t),
                          e.tribute.hideMenu();
                      }, 0));
                  },
                  escape: function (t, n) {
                  ...
                  up: function (t, n) {
                    if (e.tribute.isActive && e.tribute.current.filteredItems) {
                      ...
                      i > r && r > 0
                        ? (e.tribute.menuSelected--, e.setActiveLi())
                        : 0 === r &&
                          ((e.tribute.menuSelected = i - 1),
                          e.setActiveLi(),
                          (e.tribute.menu.scrollTop =
                            e.tribute.menu.scrollHeight));
                    }
                  },
                  down: function (t, n) {
                    if (e.tribute.isActive && e.tribute.current.filteredItems) {
                      ...
                      i > r
                        ? (e.tribute.menuSelected++, e.setActiveLi())
                        : i === r &&
                          ((e.tribute.menuSelected = 0),
                          e.setActiveLi(),
                          (e.tribute.menu.scrollTop = 0));
                    }
                  },
                  delete: function (t, n) {
                    e.tribute.isActive &&
                    e.tribute.current.mentionText.length < 1
                      ? e.tribute.hideMenu()
                      : e.tribute.isActive && e.tribute.showMenuFor(n);
                  },
                };
              },
            },
            ...
            value: function (e) {
              ...
              (this.menuClickEvent = this.tribute.events.click.bind(
                ...
                (this.menuContainerScrollEvent = this.debounce(
                  function () {
                    t.tribute.isActive &&
                      t.tribute.showMenuFor(t.tribute.current.element, !1);
                  },
                  300,
                  !1
                )),
                (this.windowResizeEvent = this.debounce(
                  function () {
                    t.tribute.isActive &&
                      t.tribute.range.positionMenuAtCaret(!0);
                  },
                  300,
                  !1
                )),
        ...
        n(t, [
            ...
            value: function (e) {
              ...
              if (void 0 !== r) {
                if (!this.tribute.positionMenu)
                  return void (this.tribute.menu.style.cssText =
                    "display: block;");
                (t = this.isContentEditable(i.element)
                  ? this.getContentEditableCaretPosition(r.mentionPosition)
                  ...
                  "auto" === t.left && (this.tribute.menu.style.left = "auto"),
                  "auto" === t.top && (this.tribute.menu.style.top = "auto"),
                  ...
                  window.setTimeout(function () {
                    ...
                    (o || u) &&
                      ((n.tribute.menu.style.cssText = "display: none"),
                      n.positionMenuAtCaret(e));
                  }, 0);
          ...
          },
          {
            ...
            value: function (e, t, n) {
              ...
              (i = this.getDocument().createRange()).setStart(r, n),
                i.setEnd(r, n),
                i.collapse(!0);
              try {
                u.removeAllRanges();
              ...
              if (void 0 !== o) {
                var u = this.tribute.current,
                  l = new CustomEvent("tribute-replaced", {
                    detail: { item: r, instance: u, context: o, event: i },
                  });
                if (this.isContentEditable(u.element)) {
                  e +=
                    "string" == typeof this.tribute.replaceTextSuffix
                      ? this.tribute.replaceTextSuffix
                      : " ";
                  var s = o.mentionPosition + o.mentionText.length;
                  this.tribute.autocompleteMode ||
                    (s += o.mentionTriggerChar.length),
                    this.pasteHtml(e, o.mentionPosition, s);
                } else {
                  ...
                  this.tribute.autocompleteMode ||
                    (d += o.mentionTriggerChar.length - 1),
                    (a.value =
                      a.value.substring(0, h) +
                      e +
                      a.value.substring(d, a.value.length)),
                    (a.selectionStart = h + e.length),
                    (a.selectionEnd = h + e.length);
                }
                u.element.dispatchEvent(
          ...
          },
          {
            ...
            value: function (e, t, n) {
              ...
              (r = this.getWindowSelection()),
                (i = this.getDocument().createRange()).setStart(
                  r.anchorNode,
                  t
                ),
                i.setEnd(r.anchorNode, n),
                i.deleteContents();
              var o = this.getDocument().createElement("div");
              o.innerHTML = e;
              for (
                var u, l, s = this.getDocument().createDocumentFragment();
                (u = o.firstChild);
              ...
              i.insertNode(s),
                l &&
                  ((i = i.cloneRange()).setStartAfter(l),
                  i.collapse(!0),
                  r.removeAllRanges(),
                  r.addRange(i));
            },
            ...
            value: function (e) {
              ...
              if (null != n) {
                for (var r, o = n.contentEditable; null !== n && "true" !== o; )
                  (r = this.getNodePositionInParent(n)),
                    i.push(r),
                    null !== (n = n.parentNode) && (o = n.contentEditable);
                return (
                  i.reverse(),
                  { selected: n, path: i, offset: t.getRangeAt(0).startOffset }
                );
              }
            },
          },
              ...
              if (null != h) {
                ...
                if (
                  (this.tribute.collection.forEach(function (e) {
                    var t = e.trigger,
                      i = e.requireLeadingSpace
                        ? s.lastIndexWithLeadingSpace(h, t)
                        : h.lastIndexOf(t);
                    i > m && ((m = i), (f = t), (n = e.requireLeadingSpace));
                  }),
                  m >= 0 &&
                    (0 === m || !n || /[\xA0\s]/g.test(h.substring(m - 1, m))))
                ) {
                  ...
                  var b = i ? /[^\S ]/g : /[\xA0\s]/g;
                  if (
                    ((this.tribute.hasTrailingSpace = b.test(p)),
                    !g && (e || !b.test(p)))
                  )
                    return {
                      mentionPosition: m,
          ...
          },
          {
            ...
            value: function (e, t, n) {
              ...
              (r.id = "input-textarea-caret-position-mirror-div"),
                this.getDocument().body.appendChild(r);
              var o = r.style,
                u = window.getComputedStyle
                  ? getComputedStyle(e)
                  : e.currentStyle;
              (o.whiteSpace = "pre-wrap"),
                "INPUT" !== e.nodeName && (o.wordWrap = "break-word"),
                (o.position = "absolute"),
                (o.visibility = "hidden"),
                [
                  "direction",
                ...
                i
                  ? ((o.width = "".concat(parseInt(u.width) - 2, "px")),
                    e.scrollHeight > parseInt(u.height) &&
                      (o.overflowY = "scroll"))
                  : (o.overflow = "hidden"),
              ...
              var y = this.tribute.menuContainer
              ...
              return (
                (b = this.isMenuOffScreen(m, g)).left &&
                  ((m.left = p > g.width ? c + p - g.width : c),
                  delete m.right),
                b.top &&
                  ((m.top = v > g.height ? h + v - g.height : h),
                  delete m.bottom),
                this.getDocument().body.removeChild(r),
                m
              );
            },
          },
          {
            ...
            value: function (e) {
              ...
              (t = this.getDocument().createRange()).setStart(n.anchorNode, e),
                t.setEnd(n.anchorNode, e),
                t.collapse(!1);
              var i = t.getBoundingClientRect(),
                r = document.documentElement,
                o = (window.pageXOffset || r.scrollLeft) - (r.clientLeft || 0),
                u = (window.pageYOffset || r.scrollTop) - (r.clientTop || 0),
                l = { left: i.left + o, top: i.top + i.height + u },
                s = window.innerWidth,
                a = window.innerHeight,
                c = this.getMenuDimensions(),
                h = this.isMenuOffScreen(l, c);
              h.right && ((l.left = "auto"), (l.right = s - i.left - o));
              var d = this.tribute.menuContainer
                ? this.tribute.menuContainer.offsetHeight
                : this.getDocument().body.offsetHeight;
              if (h.bottom) {
                var f =
              ...
              return (
                (h = this.isMenuOffScreen(l, c)).left &&
                  ((l.left = s > c.width ? o + s - c.width : o),
                  delete l.right),
                h.top &&
                  ((l.top = a > c.height ? u + a - c.height : u),
                  delete l.bottom),
                this.menuContainerIsBody ||
                  ((l.left = l.left
                    ? l.left - this.tribute.menuContainer.offsetLeft
                    : l.left),
                  (l.top = l.top
                    ? l.top - this.tribute.menuContainer.offsetTop
                    : l.top)),
                l
              );
            },
            ...
            value: function (e) {
              ...
              if (void 0 !== n) {
                for (; void 0 === t || 0 === t.height; )
                  if (
                    0 === (t = n.getBoundingClientRect()).height &&
                    (void 0 === (n = n.childNodes[0]) ||
                      !n.getBoundingClientRect)
                  )
                    return;
                var i = t.top,
                  r = i + t.height;
                if (i < 0) window.scrollTo(0, window.pageYOffset + t.top - 20);
        ...
        n(t, [
          ...
          },
          {
            ...
            value: function (e, t, n) {
              ...
              return u
                ? { rendered: this.render(t, u.cache, i, r), score: u.score }
                : null;
            },
          },
          {
            ...
            value: function (e, t, n, i, r) {
              ...
              if (!(e.length === n || t.length - i > e.length - n)) {
                for (var o, u, l = t[i], s = e.indexOf(l, n); s > -1; ) {
                  if (
                    (r.push(s),
                    (u = this.traverse(e, t, s + 1, i + 1, r)),
                    r.pop(),
                    !u)
                  )
                    return o;
                  (!o || o.score < u.score) && (o = u),
                    (s = e.indexOf(l, s + 1));
                }
                return o;
              }
              ...
              return (
                t.forEach(function (o, u) {
                  r +=
                    ...
                    e[o] +
                    i +
                    e.substring(o + 1, t[u + 1] ? t[u + 1] : e.length);
                }),
                r
              );
            },
  ...
  return (function () {
    function t(n) {
      ...
      if (
        ...
        (this.allowSpaces = _),
        (this.replaceTextSuffix = Y),
        (this.positionMenu = K),
        (this.hasTrailingSpace = !1),
        (this.spaceSelectsMatch = U),
        this.autocompleteMode && ((w = ""), (_ = !1)),
        c)
      )
        this.collection = [
          {
        ...
        this.autocompleteMode &&
          ...
          (this.collection = O.map(function (e) {
            return {
              trigger: e.trigger || w,
              iframe: e.iframe || d,
              ...
              selectTemplate: (
                e.selectTemplate || t.defaultSelectTemplate
              ).bind(r),
              menuItemTemplate: (
                e.menuItemTemplate || t.defaultMenuItemTemplate
              ).bind(r),
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (
                ...
                for (var t = e.length, n = 0; n < t; ++n) this._attach(e[n]);
              else this._attach(e);
            },
          },
          {
            ...
            value: function (e) {
              if (-1 === t.inputTypes().indexOf(e.nodeName)) {
                if (!e.contentEditable)
                  throw new Error("[Tribute] Cannot bind to " + e.nodeName);
                e.contentEditable = !0;
              }
            },
          },
                ...
                var r = function (e) {
                  if (n.isActive) {
                    var r = n.search.filter(n.current.mentionText, e, {
                      ...
                      extract: function (e) {
                        if ("string" == typeof n.current.collection.lookup)
                          return e[n.current.collection.lookup];
                        if ("function" == typeof n.current.collection.lookup)
                          return n.current.collection.lookup(
                            e,
                            n.current.mentionText
                          );
                        throw new Error(
                    ...
                    n.current.collection.menuItemLimit &&
                      (r = r.slice(0, n.current.collection.menuItemLimit)),
                      (n.current.filteredItems = r);
                    ...
                    if ((n.range.positionMenuAtCaret(t), !r.length)) {
                      ...
                      return (
                        n.current.element.dispatchEvent(u),
                        void (("function" ==
                          typeof n.current.collection.noMatchTemplate &&
                          !n.current.collection.noMatchTemplate()) ||
                        !n.current.collection.noMatchTemplate
                          ? n.hideMenu()
                          : "function" ==
                            typeof n.current.collection.noMatchTemplate
                    ...
                    r.forEach(function (e, t) {
                      ...
                      r.setAttribute("data-index", t),
                        (r.className = n.current.collection.itemClass),
                        ...
                        n.menuSelected === t &&
                          r.classList.add(n.current.collection.selectClass),
                        (r.innerHTML =
                          n.current.collection.menuItemTemplate(e)),
                        l.appendChild(r);
                    }),
                      o.appendChild(l);
                  }
                };
                "function" == typeof this.current.collection.values
                  ? this.current.collection.values(this.current.mentionText, r)
                  : r(this.current.collection.values);
              }
            },
          },
          {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              if (
                ...
                for (var t = e.length, n = 0; n < t; ++n) this._detach(e[n]);
              else this._detach(e);
            },
          },
          {
